...
$routes->get('listar-piezas', 'Pieza::listarPiezas');
...
$routes->post('torres-ajax', 'Torre::listarTorresAjax');
$routes->post('detalle-torre-ajax', 'Torre::listarDetalleTorreAjax');
...
$routes->get('pdf-guia-ingreso-(:num)', 'Guia::imprimir_guia_devolucion/$1');
