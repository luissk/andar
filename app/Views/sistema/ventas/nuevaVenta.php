...
if( isset($venta_bd) ){
    ...
    //print_r($detalle_bd);
    echo "</pre>";
    $nrodoc  = $venta_bd['ven_nrodoc'];
    $fecha   = $venta_bd['ven_fecha'];
    $cliente = $venta_bd['ven_cliente'];
    $ruc     = $venta_bd['ven_ruc'];
    $idventa = $venta_bd['idventa'];

    $card_title = "Modificar Venta";
    ...
    foreach( $detalle_bd as $d ){
        $item = array(
            ...
            "cant"    => $d['cantidad'],
            "preciov" => $d['precioven'],
            "preciot" => $d['cantidad'] * $d['precioven']
        );
    ...
    $card_title = "Nueva Venta";
    $btn_title  = "GUARDAR VENTA";
                        ...
                        <form id="frmVenta">
                            <div class="row">
                                ...
                                <div class="col-sm-5 mb-3">
                                    ...
                                    <input type="text" class="form-control" id="cliente" name="cliente" value="<?=$cliente?>" maxlength="150">
                                ...
                                <div class="col-sm-2 mb-3">
                                    <label for="preciov" class="form-label">Precio C</label>
                                    <input type="text" class="form-control numerocondecimal" name="preciov" id="preciov" value="" maxlength="11">
                                    <div id="msj-preciov" class="form-text text-danger"></div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <p class="text-center bg-body-secondary">DETALLE DE VENTA</p>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12 text-center">
                                    <input type="hidden" name="idven" id="idven" value="<?=$idventa?>">
                                    <button id="btnVenta" class="btn btn-warning"><?=$btn_title?></button>
                                </div>
                            </div>
...
$(function(){
    ...
    $("#btnAdd").on('click', function(e){
        ...
        else if( cliente == '' ) men = 'Ingrese un cliente';
        ...
        else if( preciov == '' || preciov == undefined ) men = 'Ingrese el precio de venta';
    ...
    $("#frmVenta").on('submit', function(e){
        e.preventDefault();
        let btn = document.querySelector('#btnVenta'),
